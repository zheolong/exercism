...
int main(int argc, char *argv[]) {
  ...
  int errorcode;
  int rc;
  PCRE2_SPTR pattern = "^([^\t]+)\t([^\t]+)\t([0-9a-fA-F]+)\t([0-9a-fA-F]+)$";
  PCRE2_SPTR value = "/tmp/logkafka/systest/src/logkafka_test /tmp/logkafka/systest/src/logkafka_test 0000000000000002    04dc6871";
